...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>?wysiwyg=<?php echo $wysiwyg; ?><?=$linkparm?>" enctype="multipart/form-data">
...
<td style="vertical-align: top;width: 150px; padding-left: 5px;">
	...
	<iframe id="chooser" frameborder="0" style="height:165px;width: 180px;border: 2px solid #FFFFFF; padding: 5px;" src="select_image.php?dir=<?=$leadon?><?=$linkparm?>"></iframe>
</td>
</tr>
<tr>
