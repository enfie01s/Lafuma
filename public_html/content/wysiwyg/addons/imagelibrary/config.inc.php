 ...
 */
$linkparm = "&amp;imagepaths=".$_GET['imagepaths'];
$imagepaths = explode("|",$_GET['imagepaths']);
$uploaddir=$imagepaths[2].$imagepaths[0];
$imagebasedir = $imagepaths[0];
$rootdir=$imagepaths[2];

/*
 * An absolute or relative URL to the image folder.
 * This url is used to generate the source of the image.
 */
$imagebaseurl=$imagepaths[1];
/*
