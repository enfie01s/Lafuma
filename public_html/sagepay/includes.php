...
$strDatabaseUser=$dbuser; // Change this if you created a different user name to access the database
$strDatabasePassword=$dbpass; // Set the password for the above user here
$strDatabase=$dbname; // Change this if you created a different database name
$strVirtualDir=""; // Change if you've created a Virtual Directory in IIS with a different name
$orders_email="lafumaorders@llc-ltd.co.uk";
...
$strVendorName="lafuma"; // Set this value to the Vendor Name assigned to you by Sage Pay or chosen when you applied
